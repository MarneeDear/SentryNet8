...
{
	public class OfficeLocationSourceDetail
	{
		[Key]
        ...
        public int? StateMasterId_SourceValue { get; set; }
        public int? StateMasterId_CurrentValue { get; set; }
        ...
        public int? CountryMasterId_SourceValue { get; set; }
        public int? CountryMasterId_CurrentValue { get; set; }
