...
{
    [Table("Employees_Base", Schema = "Integration")]
    public class EmployeeHistory : BaseHistory
    {
        #region First Name
        ...
        public string EmployeeId_Status { get; set; }

        public int? EmployeeId_AttributeId { get; set; }
        #endregion
